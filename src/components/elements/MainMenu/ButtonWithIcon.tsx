...
function ButtonWithIcon (props: any) {
    ...
    switch (props.iconName) {
        case "heart":
            jsxElement = 
                <div className='MainMenu__ButtonWithIcon'>
                    <img className='ButtonWithIconImg' src={icon_heart} alt="" aria-hidden="true" data-noaft="" />                    
        ...
        case "package":
            jsxElement = 
                <div className='MainMenu__ButtonWithIcon'>
                    <img className='ButtonWithIconImg' src={icon_package} alt="" aria-hidden="true" data-noaft="" />                    
                    <div className='MainMenu__ButtonWithIconText'>{props.buttonText}</div>                   
                </div>
            ;
            break;
        ...
        case "basket":
                jsxElement = 
                    <div className='MainMenu__ButtonWithIcon'>
                        <img className='ButtonWithIconImg' src={icon_basket} alt="" aria-hidden="true" data-noaft="" />                    
                        <div className='MainMenu__ButtonWithIconText'>{props.buttonText}</div>                   
                    </div>
                ;
                break;
        ...
        default:
                jsxElement = 
                    <div className='MainMenu__ButtonWithIcon'>
                        ...
                        <div className='MainMenu__ButtonWithIconText'>{props.CatigoryName}</div>                   
                    </div>
                ;
                break;        
    }   
